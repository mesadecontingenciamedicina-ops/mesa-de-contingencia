...
> **Última actualización:** 2026-07-03 (Modal ✏️ de tareas: filtra miembros por grupo y permite editar la descripción; `PUT /api/tareas/:id` ahora acepta `descripcion` además de `estado`)
